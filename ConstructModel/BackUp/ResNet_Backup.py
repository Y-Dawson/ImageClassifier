...
from layers import DropBlock2d, DropPath, AvgPool2dSame, BlurPool2d, GroupNorm, create_attn, create_classifier
...
#model_args = dict( num_classes=1000, in_chans=3)

resNet = ResNet(block=BasicBlock, layers=[2, 2, 2, 2], num_classes=1000, in_chans=3)
