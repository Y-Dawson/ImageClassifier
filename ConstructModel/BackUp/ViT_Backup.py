...
#from layers import PatchEmbed, _no_grad_trunc_normal_, trunc_normal_, variance_scaling_, lecun_normal_
from layers import *
from helpers import *
#temp
...
def _cfg(url='', **kwargs):
    return {
        ...
        'mean': (0.485, 0.456, 0.406), 'std': (0.229, 0.224, 0.225), #imageNetMeanPara
...
img = Image.open("C:\\Users\\Dawson\\Desktop\\1.jpg")
